 ...
 */
public class VisualizarDadosFuncionario extends javax.swing.JFrame {
     ...
     */
    public VisualizarDadosFuncionario(Funcionario umFuncionario){
        initComponents();
        try {
        ...
        usuario.setText("Nome de Usuário - " + funcionario2.getUsuario());
        senha.setText("Senha - " + "********");
        email.setText("Email - " + emailV);
    }
    
    public VisualizarDadosFuncionario(){
        initComponents();
        try {
            Image icon = Toolkit.getDefaultToolkit().getImage("src\\Imagens\\images.png");
            setIconImage(icon);
    ...
    private void initComponents() {
        ...
        email.setBounds(200, 270, 170, 30);
        ...
        usuario.setBounds(200, 170, 170, 30);
    ...
    private void voltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_voltarActionPerformed
        try {
            new PaginaDeAcessoFuncionario(this.umFuncionario).setVisible(true);
        } catch (Exception e) {
            e.printStackTrace();
        }
        dispose();
